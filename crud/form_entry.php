...
<div class="bg-white rounded shadow p-4 mb-5">
    ...
    <div class="alert alert-primary rounded-4 mb-5" role="alert">
        <i class="fa-solid fa-pen-to-square me-2"></i> Entry Data
    </div>

    <!-- form entri data -->
    <form action="proses_simpan.php" method="post" enctype="multipart/form-data"  class="need-validated" novalidate>
        <div class="row">
            <div class="col-xl-6">
                <div class="row g-0">
                    ...
                    <div class="mb-3 col-xl-6 pe-xl-3">
                        ...
                        <input type="date" name="tanggal_daftar" class="form-control" autocomplete="off" required>
                ...
                <div class="mb-3 ps-xl-3">
                    ...
                    <select name="id_skema" class="form-select" autocomplete="off" required>
                        ...
                        while ($skema = $getskema->fetch_assoc()) {
                            ...
                            echo '<option value="' . $id_skema . '">' . $nama_skema . '</option>';
                        }
                        ?>
                    </select>
