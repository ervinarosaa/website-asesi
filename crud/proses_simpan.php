...
if (isset($_POST['simpan'])) {
    ...
    $id_skema      = $mysqli->real_escape_string(trim($_POST['id_skema']));
    ...
    if (move_uploaded_file($tmp_file, $path)) {
        ...
        $insert = $mysqli->query("INSERT INTO `tbl_siswa`(`id_siswa`, `tanggal_daftar`, `id_skema`, `nama_lengkap`, `jenis_kelamin`, `alamat`, `email`, `whatsapp`, `foto_profil`)
                                    VALUES('$id_siswa', '$tanggal_daftar', '$id_skema', '$nama_lengkap', '$jenis_kelamin', '$alamat', '$email', '$whatsapp', '$nama_file_enkripsi')")
